...
export const testData: ColumnProps[] = [
  ...
  },
  {
    ...
    avatar: 'http://vue-maker.oss-cn-hangzhou.aliyuncs.com/vue-marker/6183abd6fc0f930997b02815.jpg?x-oss-process=image/resize,m_pad,h_50,w_50'
  },
  {
    id: 4,
    title: '自然语言处理训练营',
    description: '如何提升预防接种服务能力？海尔生物：数字化、物联化或是最优解',
    avatar: 'http://vue-maker.oss-cn-hangzhou.aliyuncs.com/vue-marker/5f3e41b3b7d9c60b68cdd1ee.jpg?x-oss-process=image/resize,m_pad,h_50,w_50'
  },
  {
    id: 5,
    title: 'Alter聊科技',
  ...
  },
  {
    ...
    avatar: 'http://vue-maker.oss-cn-hangzhou.aliyuncs.com/vue-marker/5f3e41b8b7d9c60b68cdd1ef.jpg?x-oss-process=image/resize,m_pad,h_50,w_50'
  }
]
